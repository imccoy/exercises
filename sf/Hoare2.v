...
Proof.
  ...
  unfold assn_sub. intros st Hpre.
    simpl. unfold t_update. simpl. inversion Hpre. rewrite parity_ge_2. assumption.
    unfold bassn in H. unfold bassn in H0. unfold beval in H0. apply leb_complete. replace 2 with (aeval st (ANum 2)). replace (st X) with (aeval st (AId X)). assumption. reflexivity. reflexivity.
