...
Fixpoint increment_bin (n : bin) : bin :=
  ...
  | Empty => I Empty
  | O n'  => I n'
  | I n' => O (increment_bin n')
  end.

Example increment_bin_test1 : increment_bin Empty = I Empty.
Proof. reflexivity. Qed.


Example increment_bin_test2 : increment_bin (O Empty) = I Empty.
Proof. reflexivity. Qed.


Example increment_bin_test3 : increment_bin (I Empty) = O (I Empty).
Proof. reflexivity. Qed.

Example increment_bin_test4 : increment_bin (I (O (I (O Empty))))
                               = (O (I (I (O Empty)))).
Proof. reflexivity. Qed.
